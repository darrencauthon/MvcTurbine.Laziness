...
{
    [TestFixture]
    public class StructureMapLazyTests
    {
        [Test]
        public void Throws_an_invalid_operation_exception_when_called_without_setting_the_service_locator()
        {
            ...
            try
            {
                var lazy = new StructureMapLazy<TestClass>(null);
            }
        ...
        {
            var lazy = new StructureMapLazy<TestClass>(new TestServiceLocator());
        ...
        public void Returns_the_resolved_value_from_the_service_locator()
        {
            ...
            var lazy = new StructureMapLazy<TestClass>(serviceLocator);
