...
namespace MvcTurbine.Laziness.Unity.Tests
{
    ...
    public class UnityLazyTests
    {
        ...
        public void Throws_an_invalid_operation_exception_when_called_without_setting_the_service_locator()
        {
            ...
            try
            {
                var lazy = new UnityLazy<TestClass>(null);
            }
        ...
        {
            var lazy = new UnityLazy<TestClass>(new TestServiceLocator());
        ...
        public void Returns_the_resolved_value_from_the_service_locator()
        {
            ...
            var lazy = new UnityLazy<TestClass>(serviceLocator);
